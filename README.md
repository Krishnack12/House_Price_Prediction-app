...
**Model Evaluation**
The performance of the model is evaluated using the R-squared (R²) score, which measures how well the model explains the variance in house prices. The trained model achieves a satisfactory prediction accuracy, making it suitable for real-time price estimation.
